...
<p>For a problem to be solved using the Greedy approach, it must follow a few major characteristics:<br></br>

There is an ordered list of resources(profit, cost, value, etc.) <br></br>
Maximum of all the resources(max profit, max value, etc.) are taken. <br></br>
